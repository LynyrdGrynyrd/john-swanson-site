  ...
  <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden", paddingTop: 80 }}>
    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px", width: "100%", position: "relative", zIndex: 1 }}>
      <div className="hero-grid" style={{ display: "flex", alignItems: "center", gap: "clamp(40px, 6vw, 80px)" }}>
        <div style={{ flex: 1 }}>
          <div className="hero-enter" style={{ "--d": "0.1s", display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 20, padding: "6px 12px", border: "1px solid var(--clr-border)", borderRadius: 999, fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "var(--clr-text-muted)", letterSpacing: 0.5, background: "var(--clr-nav-bg)" }}>
            <span className="status-dot" />
            Director of Innovation Portfolio · Polymer Industry Cluster
          </div>

          <h1 className="hero-name" style={{ fontFamily: "'Source Serif 4', serif", fontSize: "clamp(48px, 9vw, 108px)", fontWeight: 300, lineHeight: 0.95, letterSpacing: "-0.02em", color: "var(--clr-text)", marginBottom: 24 }}>
            <span className="hero-name-line">
              <span className="hero-word" style={{ "--d": "0.25s" }}>John</span>
            </span>
            <span className="hero-name-line">
              <em className="hero-word hero-surname" style={{ "--d": "0.4s" }}>Swanson</em>
            </span>
          </h1>

          <p className="motto-text hero-enter" style={{ "--d": "0.7s", marginBottom: 28 }}>Built in the lab. Proven in the boardroom.</p>

          <p className="hero-enter" style={{ "--d": "0.85s", fontFamily: "'DM Sans', sans-serif", fontSize: "clamp(17px, 2.1vw, 21px)", lineHeight: 1.6, color: "var(--clr-text-sec)", maxWidth: 560 }}>
          ...
          <p className="hero-enter" style={{ "--d": "0.95s", fontFamily: "'DM Sans', sans-serif", fontSize: 15, lineHeight: 1.8, color: "var(--clr-text-muted)", marginTop: 16, maxWidth: 580 }}>
          ...
          <div className="hero-buttons hero-enter" style={{ "--d": "1.05s", marginTop: 40, display: "flex", gap: 20, flexWrap: "wrap" }}>
        ...
        <div className="headshot-orbit hero-enter" style={{ "--d": "0.5s" }}>
